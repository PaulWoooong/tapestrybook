...
public class AppModule {
	...
	public static void contributeMasterDispatcher(
		...
		configuration.addInstance("AuthorizationDispatcher",
				AuthorizationDispatcher.class, "after:ComponentEvent",
				"before:PageRender");
	}
	...
	public static void contributeAlias(
		...
		AliasContribution<BaseURLSource> contribution = AliasContribution
				.create(BaseURLSource.class, source);
