...
import de.t5book.services.impl.ReportServiceImpl;
import de.t5book.services.impl.VoteServiceImpl;
...
public class AppModule {
	...
	public static VoteService buildVoteService(
			HibernateSessionManager hibernateSessionManager) {
		VoteService voteService = new VoteServiceImpl(hibernateSessionManager);
		voteService.createDemoData();
		return voteService;
	}
