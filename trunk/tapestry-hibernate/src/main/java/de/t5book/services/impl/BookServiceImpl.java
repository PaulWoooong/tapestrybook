...
public class BookServiceImpl implements BookService {
	...
	public void createDemoData() {
		...
		save(createBook("Patterns of Enterprise Application Architecture",
				"Martin Fowler", newDate(2002, 10, 15), "978-0321127426", 37.95));
		save(createBook("Handbuch der Java-Programmierung",
				"Guido Krüger et al.", newDate(2009, 6, 29), "978-3827323736",
				49.80));
