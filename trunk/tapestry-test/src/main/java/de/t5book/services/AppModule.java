...
import de.t5book.services.impl.AnotherServiceImpl;
import de.t5book.services.impl.MailingServiceImpl;
...
public class AppModule {
	...
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(MailingService.class, MailingServiceImpl.class);
