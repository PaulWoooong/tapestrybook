...
//			final MappedConfiguration<Class, ValueEncoderFactory> configuration, final BookService bookService) {
//		
//		ValueEncoderFactory<Book> factory = new ValueEncoderFactory<Book>(){
//
//			public ValueEncoder<Book> create(Class<Book> clazz) {
//				return new BookEncoder(bookService);
//			}};
//		configuration.add(Book.class, factory);
//	}
}
