...
import de.t5book.services.impl.SessionAttributeWorker;
...
public class AppModule {
    ...
    public static void contributeComponentClassTransformWorker(
            OrderedConfiguration<ComponentClassTransformWorker> configuration, ObjectLocator objectLocator){
    	configuration.add("SessionAttribute", new SessionAttributeWorker(objectLocator));
    }
